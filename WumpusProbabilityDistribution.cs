...
{
    internal class WumpusProbabilityDistribution
    {
        ...
        public WumpusProbabilityDistribution(Button[,] board, string tag)
        {
            _board = board;
        ...
        public void UpdateProbabilities()
        {
            ...
            else
            {
                ...
                foreach (var p in @unsafe)
                    _probDist[p.Item1, p.Item2] = (float)1 / @unsafe.Count;
            }
        }
